...
def test_banner_mask():
    ...
    overlay_canvas.set_blur_preset("banner")
    ...
    def capture():
        ...
        art_path = "C:/Users/RPC/.gemini/antigravity-ide/brain/f8d82df2-0221-451b-9950-3f7716e7d6bc/dark_banner_mask_verified.png"
        pix.save(art_path)
        print(f"[TEST LOG] Dark Banner Mask screenshot saved to: {art_path}")
        app.quit()
