...
def test_proxy_overlay():
    ...
    overlay_canvas.blur_x_pct = 0.40
    overlay_canvas.blur_y_pct = 0.15
    overlay_canvas.blur_w_pct = 0.20
    ...
    def capture():
        ...
        art_path = "C:/Users/RPC/.gemini/antigravity-ide/brain/f8d82df2-0221-451b-9950-3f7716e7d6bc/proxy_video_blur.png"
        pix.save(art_path)
        print(f"[TEST LOG] Proxy QGraphicsView Video Blur screenshot saved to: {art_path}")
        app.quit()
