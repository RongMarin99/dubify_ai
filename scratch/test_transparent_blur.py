...
def test_transparent_blur():
    ...
    overlay_canvas.set_blur_preset("transparent")
    ...
    def capture():
        ...
        art_path = "C:/Users/RPC/.gemini/antigravity-ide/brain/f8d82df2-0221-451b-9950-3f7716e7d6bc/pure_transparent_glass_blur.png"
        pix.save(art_path)
        print(f"[TEST LOG] Pure Transparent Glass Blur screenshot saved to: {art_path}")
        app.quit()
